...
'''
Point-voxel convolutional autoencoder. Operates on point-cloud data via voxelized
convolution branch and point-based shared MLP branch.
...
class Model(pl.LightningModule):
    ...
    def __init__(self,*,
        ...
        conv_in_shape = torch.Size([input_shape[0], input_shape[1]])+self.voxelizer._grid_shape
